...
const STRING_SYMBOL = Symbol.for("@tcons/core.TokenMap.STRING");
const LIST_SYMBOL = Symbol.for("@tcons/core.TokenMap.LIST");
const NUMBER_SYMBOL = Symbol.for("@tcons/core.TokenMap.NUMBER");
const NUMBER_LIST_SYMBOL = Symbol.for("@tcons/core.TokenMap.NUMBER_LIST");
const MAP_SYMBOL = Symbol.for("@tcons/core.TokenMap.MAP");
