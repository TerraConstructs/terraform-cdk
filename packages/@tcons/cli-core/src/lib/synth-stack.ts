...
import { logger, readConfigSync, sendTelemetry, shell } from "@tcons/commons";
import { CdktfConfig } from "./cdktf-config";
import { format } from "@tcons/hcl-tools";
...
If not present, the tcons-cli sets it to NODE_OPTIONS="${nodeOptsSetting}" by default. But as
