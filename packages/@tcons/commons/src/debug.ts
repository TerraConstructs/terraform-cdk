...
async function getGoPackageVersion(packageName: string) {
  const translationMap: Record<string, string> = {
    ...
    cdktf: "github.com/terraconstructs/terraform-cdk-go",
  };
